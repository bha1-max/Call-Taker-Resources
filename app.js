const STORAGE_KEY = "dispatchDesk.v1";
  ...
  customNotes: [
    {
      ...
      title: "REPO Calls",
      body: "Confirm the repossession company name and callback number.\nAsk for the vehicle year, make, model, color, plate, and VIN if available.\nConfirm the pickup location and whether the vehicle is already secured.\nAsk if there are any threats, disturbances, weapons, or confrontations.\nNote if the registered owner has been notified or may call in."
    },
    {
      id: crypto.randomUUID(),
      title: "Street Parking",
      body: "Get the exact address, cross street, or closest landmark.\nAsk for the vehicle plate, state, color, make, and model.\nClarify the issue: blocked driveway, fire hydrant, abandoned, no-parking zone, timed restriction, or hazard.\nAsk how long the vehicle has been there.\nConfirm whether the caller wants contact or is only reporting."
    },
    {
      id: crypto.randomUUID(),
      title: "Private Parking",
      body: "Confirm the business, apartment complex, lot name, or private property location.\nAsk whether the caller is the property owner, manager, resident, employee, or visitor.\nGet vehicle plate, state, color, make, and model.\nAsk what rule or space is being violated.\nConfirm whether signage, permit rules, or tow authorization may apply based on local policy."
    },
    {
      id: crypto.randomUUID(),
      title: "Traffic Complaints",
      body: "Get the location, direction of travel, and last known cross street.\nAsk for vehicle description, plate, and distinguishing features.\nClarify behavior: speeding, reckless driving, DUI suspicion, road rage, racing, wrong-way, or hazard.\nAsk when it happened and whether it is still occurring.\nConfirm whether the caller is following the vehicle and remind them to stay safe if needed per policy."
    }
  ],
  phrases: {
    Adults: [
